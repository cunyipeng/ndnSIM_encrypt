  ...
  static TypeId tid =
    TypeId("ns3::ndn::Consumer")
      ...
      .AddAttribute(
         ...
         UintegerValue(0), MakeUintegerAccessor(&Consumer::m_signature),
...
Consumer::OnData(shared_ptr<const Data> data)
{
  ...
  Name tempdata = data->VerifyDigest();
  ...
  std::cout <<"node(" << GetNode()->GetId() << ") receiving with Data's Content: " << *data << std::endl;
